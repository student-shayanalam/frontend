      ...
      <div className="container border-top">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <a href="/open-account" className="footer-link">
              Open demat account
            </a>
            <br />
            <a href="/minor-account" className="footer-link">
              Minor demat account
            </a>
            <br />
            <a href="/nri-account" className="footer-link">
              NRI demat account
            </a>
            <br />
            ...
            <br />
            <a href="/demat" className="footer-link">
              Dematerialisation
            </a>
            <br />
          ...
          <div className="col">
            ...
            <br />
            <a href="/opensource" className="footer-link">
              Open source
            </a>
          </div>
          <div className="col">
            <p style={{ fontSize: "18px" }}>Quick links</p>
            <a href="/ipos" className="footer-link">
              Upcoming IPOs
            </a>
            <br />
            <a href="/brokerage" className="footer-link">
              Brokerage charges
            </a>
            <br />
            <a href="/holidays" className="footer-link">
              Market holidays
            </a>
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "12px" }}>
          <p>
            ...
            <a href="mailto:complaints@zerodha.com" className="ticket-link"> complaints@zerodha.com,</a> for DP related to <a href="mailto:dp@zerodha.com" className="ticket-link">dp@zerodha.com.</a> Please
            ensure you carefully read the Risk Disclosure Document as
            prescribed by SEBI | ICF
          </p>

          <p>
            Procedure to file a complaint on <a href="https://scores.sebi.gov.in/" className="ticket-link" target="_blank" rel="noopener noreferrer">SEBI SCORES:</a> Register on SCORES
          ...
          <p>
            <a href="/dispute-resolution" className="ticket-link">Smart Online Dispute Resolution | Grievances Redressal Mechanism</a>
          </p>
          ...
          <p>
            India's largest broker based on networth as per NSE.<a href="/nse-factsheet" className="ticket-link"> NSE broker
            factsheet</a>
          </p>
          ...
          <p>
            ...
            services, please{" "}
            <a href="/create-ticket" className="ticket-link">
        ...
        <div className="container text-center">
          <ul className="list-inline mb-0" style={{ fontSize: "14px" }}>
            <li className="list-inline-item mx-3">
              <a href="/nse" className="footer-link">
                NSE
              </a>
            </li>
            <li className="list-inline-item mx-3">
              <a href="/bse" className="footer-link">
                BSE
              </a>
            </li>
            <li className="list-inline-item mx-3">
              <a href="/mcx" className="footer-link">
                MCX
              </a>
            </li>
            <li className="list-inline-item mx-3">
            ...
            <li className="list-inline-item mx-3">
              <a href="/investor-attention" className="footer-link">
